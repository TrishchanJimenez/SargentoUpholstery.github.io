...
<head>
    ...
    <link rel="stylesheet" href="../css/cms_test.css">
...
<body>
    <div class="wrapper">
        <div class="admin-sidebar">
            ...
            <ul class="admin-nav">
                <a href="./dashboard.php" class="admin-link" data-page="dashboard">
                    ...
                    <!-- <svg class="unhovered" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#C4CAD4"><path d="M120-520v-320h320v320H120Zm0 400v-320h320v320H120Zm400-400v-320h320v320H520Zm0 400v-320h320v320H520ZM200-600h160v-160H200v160Zm400 0h160v-160H600v160Zm0 400h160v-160H600v160Zm-400 0h160v-160H200v160Zm400-400Zm0 240Zm-240 0Zm0-240Z"/></svg> -->
                    <span>Dashboard</span>
                </a>
                ...
                <a href="./cms.php" class="admin-link" data-page="cms">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="body">
            ...
            <div class="active-tab">
                <div class="tab" data-page="home">
                    ...
                    <div class="product">
                        <h2 class="product-category-title editable short-text" data-id="HOMECRAFTSTITLE"><?= $contentsById["HOMECRAFTSTITLE"]["content_text"] ?></h2>
                        <p class="product-category-intro editable long-text" data-id="HOMECRAFTSTEXT"><?= $contentsById["HOMECRAFTSTEXT"]["content_text"] ?></p>
                    ...
                    <div class="about-us">
                        ...
                        <h2 class="text-gold editable short-text" data-id="HOMEABOUTTITLE"><?= $contentsById["HOMEABOUTTITLE"]["content_text"] ?></h2>
                        <p class="business-history editable long-text" data-id="HOMEABOUTTEXT"><?= $contentsById["HOMEABOUTTEXT"]["content_text"] ?></p>
                ...
                <div class="tab" data-page="services-craftsmanship">
                    ...
                    <div class="intro-section">
                        <h2 class="intro-title editable short-text" data-id="CRAFTSHEADERTITLE"><?= $contentsById["CRAFTSHEADERTITLE"]["content_text"] ?></h2>
                        <p class="intro-info editable long-text" data-id="CRAFTSHEADERTEXT"><?= $contentsById["CRAFTSHEADERTEXT"]["content_text"] ?></p>
                    ...
                    <div class="services_craftmanship_card_container">
                        <div class="services_craftmanship_card">
                            ...
                            <div class="services_craftmanship_card_text"> 
                                <h1 class="text-gold editable short-text" data-id="CRAFTSCARDTITLE1"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTITLE1"]["content_text"]) ?></h1>
                                <p class="editable long-text" data-id="CRAFTSCARDTEXT1"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTEXT1"]["content_text"]) ?></p>
                            </div>
                        </div>
                        <div class="services_craftmanship_card big">
                            <div class="services_craftmanship_card_text ta-right"> 
                                <h1 class="text-gold editable short-text" data-id="CRAFTSCARDTITLE2"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTITLE2"]["content_text"]) ?></h1>
                                <p class="editable long-text" data-id="CRAFTSCARDTEXT2"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTEXT2"]["content_text"]) ?></p>
                            </div>
                        ...
                        <div class="services_craftmanship_card">
                            ...
                            <div class="services_craftmanship_card_text"> 
                                <h1 class="text-gold editable short-text" data-id="CRAFTSCARDTITLE3"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTITLE3"]["content_text"]) ?></h1>
                                <p class="editable long-text" data-id="CRAFTSCARDTEXT3"><?= htmlspecialchars_decode($contentsById["CRAFTSCARDTEXT3"]["content_text"]) ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="services_craftmanship_text_2">
                        <p class="editable long-text" data-id="CRAFTSFOOTERTEXT" data-id="CRAFTSFOOTERTEXT"><?= $contentsById["CRAFTSFOOTERTEXT"]["content_text"] ?></p>
                    </div>
                ...
                <div class="tab" data-page="services-works">
                    ...
                    <div class="intro-section">
                        <h2 class="intro-title editable short-text" data-id="WORKSHEADERTITLE"><?= $contentsById["WORKSHEADERTITLE"]["content_text"] ?></h2>
                        <p class="intro-info editable long-text" data-id="WORKSHEADERTEXT"><?= $contentsById["WORKSHEADERTEXT"]["content_text"] ?></p>
                        <a href="order.php" class="btn btn-black">Get Free Quote</a>
                    </div> 
                ...
                <div class="tab active" data-page="order">
                ...
                <div class="tab" data-page="review">
                ...
                <div class="tab" data-page="contact">
                    ...
                    <div class="contact_us_text">
                        <div class="contact_info">
                            ...
                            <p class="short-text editable" data-id="CPNNUM"><?= $contentsById["CPNNUM"]["content_text"] ?></p>
                            <h1> Mailing Adress </h1>
                            <p class="short-text editable" data-id="MAILADD"><?= $contentsById["MAILADD"]["content_text"] ?></p>
                        </div>
                        <div class="adresses">
                            <h1>Business Address</h1>
                            <p class="long-text editable" data-id="BUSIADD"><?= $contentsById["BUSIADD"]["content_text"] ?></p>
                            <h1>Business Hours</h1>
                            <p class="short-text editable" data-id="BUSIHRS"><?= $contentsById["BUSIHRS"]["content_text"] ?></p>
                        </div> 
                    </div>
                </div>
            </div>
    ...
    <script src="../js/cms_test.js"></script>
