        ...
        <div class="orders">
            ...
            <div class="orders__right-wrapper">
                <div class="order-price__wrapper">
                    <table class="order-details__table order-details__table--price">
                        <div class="order-details__title">
                            <h1>Quoted Price</h1>
                        </div>
                        <tr>
                            <td class="order-details__td order-details__td--price"><?= "Php " . number_format($order["quoted_price"] ?? 0, 2, '.', ','); ?></td>
                        </tr>
                    </table>
                </div>
