...
--
-- Host: localhost:3306
-- Generation Time: May 26, 2024 at 12:57 AM
...
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(1, 22, 22, 'imissyou', '2024-05-21 04:43:35');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(2, 22, 22, 'mwa', '2024-05-21 04:43:36');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(3, 23, 22, 'imissyou2bbk', '2024-05-21 04:56:33');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(4, 22, 22, 'jkjkjk', '2024-05-21 04:57:20');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(5, 22, 22, 'l,l,l', '2024-05-21 04:57:23');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(6, 23, 22, 'justine joven casiano\r\n', '2024-05-21 04:58:17');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(7, 23, 22, 'oyoy', '2024-05-21 05:00:56');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(8, 22, 22, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2024-05-21 05:02:26');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(9, 22, 22, 'putanginamo', '2024-05-21 07:09:38');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(10, 21, 22, 'fasdfasf', '2024-05-22 11:28:02');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(11, 21, 21, 'hello', '2024-05-23 00:13:15');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(12, 21, 21, 'fadfa', '2024-05-23 00:13:21');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(13, 21, 22, 'dfafa', '2024-05-23 00:13:39');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(14, 21, 22, 'fasf', '2024-05-23 17:17:01');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(15, 24, 22, 'sfhahfjaf', '2024-05-24 03:10:40');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(16, 24, 22, 'a', '2024-05-24 04:24:37');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(17, 24, 22, 'hello', '2024-05-24 04:26:44');
INSERT INTO `chats` (`chat_id`, `sender_id`, `customer_id`, `message`, `timestamp`) VALUES(18, 24, 22, 'hi', '2024-05-24 04:26:55');
...
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('CRAFTSHEADERTEXT', 'services_craftsmanship', NULL, 'At Sargento Upholstery, our commitment to excellence is evident in every step of our meticulous craftsmanship. We take pride in the fact that each and every one of our products is a masterpiece of quality, designed to provide both aesthetics and durability that can withstand the test of time.', NULL);
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('CRAFTSHEADERTITLE', 'services_craftsmanship', NULL, 'A Commitment to Craftsmanship Excellence', NULL);
...
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('QUOTEFEATUREDDESC', 'order', 'FEATUREDDESC', ' ', NULL);
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('QUOTEFEATUREDIMG', 'order', 'FEATUREDIMG', NULL, '/websiteimages/featured_banners/featured-image--order.png');
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('QUOTEFEATUREDTITLE', 'order', 'FEATUREDTITLE', 'Design, Craft, Quote - All in One Place', '');
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('TESTIMONIALFEATUREDDESC', 'testimonials', 'FEATUREDDESC', 'At Sargento Upholstery, our commitment to excellence is evident in every step of our meticulous craftsmanship. We take pride in the fact that each and every one of our products is a masterpiece of quality, designed to provide both aesthetics and durability that can withstand the test of time.', NULL);
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('TESTIMONIALFEATUREDIMG', 'testimonials', 'FEATUREDIMG', NULL, '/websiteimages/featured_banners/featured-image--testimonials.png');
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('TESTIMONIALFEATUREDTITLE', 'testimonials', 'FEATUREDTITLE', 'Real Reviews, Real Satisfaction', NULL);
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('WORKSFEATUREDDESC', 'services_works', 'FEATUREDDESC', 'At Sargento Upholstery, our rich history of crafting timeless furniture pieces reflects our dedication to quality craftsmanship and attention to detail. From elegant sofas to custom-designed commercial furniture, each piece tells a story of artistry and passion.', NULL);
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('WORKSFEATUREDIMG', 'services_works', 'FEATUREDIMG', NULL, '/websiteimages/featured_banners/featured-image--works.jpg');
INSERT INTO `contents` (`content_id`, `page`, `content_type`, `content_text`, `image`) VALUES('WORKSFEATUREDTITLE', 'services_works', 'FEATUREDTITLE', 'Past Creations: A Showcase of Artisan Furniture', NULL);
...
CREATE TABLE IF NOT EXISTS `quotations` (
  ...
  KEY `quotation_customer_id_fk` (`customer_id`),
