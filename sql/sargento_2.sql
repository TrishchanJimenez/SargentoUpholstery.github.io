...
CREATE TABLE `items` (
  ...
  `description` text,
  `item_img_path` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE `orders` (
  ...
  `quote_id` int DEFAULT NULL,
  `order_phase` enum('pending_down','pickup','production','pending_full','delivery','received') DEFAULT NULL,
...
CREATE TABLE `quotes` (
  ...
  `quote_status` enum('pending','approved','modified','rejected','accepted','cancelled') DEFAULT NULL,
...
(25, 'Chris Paul', 'chispaul@gmail.com', '$2y$10$dXItxFQz3d2n.9KS0MF9GOWDqBhUS8k28HEEDz3a/NkRwSBOGnLAa', 'customer', '09312818482');
...
--
ALTER TABLE `customs`
  MODIFY `custom_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `notifs`
  MODIFY `notif_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
